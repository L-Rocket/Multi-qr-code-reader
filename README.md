...
## Demo
See [Live Preview](https://l-rocket.github.io/Multi-qr-code-reader/projects/MultiQRcodeV1) in browser.
(if this does not scan QRcode immediately, please click the return button and restart. And this is a bug to be fixed soon)

see new way to achieve this [Live Preview](https://l-rocket.github.io/Multi-qr-code-reader/projects/MultiQRcodeV2) here.
## Example
